Feature: Test Chick-fil-a application
    Scenario:Create "Vendor Item"
            ...
            When user  clicks on "Harmonized Tariff Code (Schedule B) " and selects value from the given dropdown "Harmonized Tariff Code (Schedule B) "
            ...
            When user  clicks on "Price Break Quantity UOM" and selects value from the given dropdown "Price Break Quantity UOM"
